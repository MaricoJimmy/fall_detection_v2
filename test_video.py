...
class FallDetectionTester:
    def __init__(self):
        ...
        # Load YOLOv8-pose (detection + pose in one step)
    ...
    def process_frame(self, frame):
        ...
        if detections:
            ...
            # Xoa nhung nguoi khong con xuat hien
            ...
            for person_id, det_idx in matched.items():
                ...
                if skeleton is not None:
                    # Ve skeleton goc (global pixel) truoc khi normalize
    ...
    def draw_skeleton(self, frame, skeleton, offset_x, offset_y):
        """Ve skeleton len frame (COCO 17 keypoints)"""
        connections = [
